...
public class LoginValidations_UsingMultipleRowsOfTestData {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
	   ...
	   //Navigating to the application URL address
		driver.get(applicationUrlAddress);
	     FileInputStream testDataFile = new FileInputStream("C:\\Users\\swathi\\Desktop\\SeleniumPractice\\LogInTestUsingMultipleTestData.xlsx");
	 	...
	 	Cell testDataSheetRowOfCellUrl = testDataSheetRow.getCell(6);
	...
	Cell testDataSheetRowOfCell7= testDataSheetRow.createCell(7);
	...
	Cell testDataSheetRowOfCell8Result= testDataSheetRow.createCell(8);
  ...
  //Login Panel Text Validation
   ...
   WebElement LoginPanelText = driver.findElement(LoginPanelProperty);
	...
	Cell testDataSheetRowOfCell1= testDataSheetRow.createCell(1);
	...
	if(ActualLoginPanelText.equals(ExpectedloginPanelText))
	{
		...
		Cell testDataSheetRowOfCell1Result= testDataSheetRow.createCell(2);
    ...
    Cell testDataSheetRowOfCellTitle = testDataSheetRow.getCell(3);
	...
	Cell testDataSheetRowOfCell4= testDataSheetRow.createCell(4);
	...
	if(ActualPageTitle.equals(ExpectedloginPageTitle))
	{
	  ...
	  //Row testDataSheetRow1Result = TestDataSheet.getRow(1);
		...
		Cell testDataSheetRowOfCell5Result= testDataSheetRow.createCell(5);
	...
	for(int rowOfCellIndex=9; rowOfCellIndex<multipleTestDataSheetRowOfCellCount;rowOfCellIndex++)
	{
		
	
	Cell testDataSheetRowOfCell9 = testDataSheetRow.getCell(rowOfCellIndex);
	...
	// Row testDataSheetRowPassWord = TestDataSheet.getRow(1);
		for(int rowOfCellIndex1=10;rowOfCellIndex<multipleTestDataSheetRowOfCellCount;rowOfCellIndex1++)
		{
		Cell testDataSheetRowOfCell10 = testDataSheetRow.getCell(rowOfCellIndex1);
	...
	// String PasswordTestData = "Livetech@123";
	 ...
	 //Row testDataSheetRowWelcomeText = TestDataSheet.getRow(1);
		...
		Cell testDataSheetRowOfCell11 = testDataSheetRow.getCell(11);
		...
		// Row testDataSheetRowWelcomeTextActual = TestDataSheet.getRow(1);
			...
			Cell testDataSheetRowOfCell12= testDataSheetRow.createCell(12);
			...
			if(ActualWelcomeAdmin.contains(ExpectedloginWelcomeText))
			 {
				 ...
				 //Row testDataSheetRow1Result = TestDataSheet.getRow(1);
					...
					Cell testDataSheetRowOfCell13Result= testDataSheetRow.createCell(13);
			...
			//  Row testDataSheetRowLoginPanel = TestDataSheet.getRow(1);
				...
				Cell testDataSheetRowOfCell14 = testDataSheetRow.getCell(14);
			   ...
			   WebElement LoginPanelTextAfterLogout = driver.findElement(LoginPanelPropertyAfterLogout);
				...
				Cell testDataSheetRowOfCell15= testDataSheetRow.createCell(15);
				...
				if(ActualLoginPanelText.equals(ExpectedloginPanelText))
				{
					...
					Cell testDataSheetRowOfCell16Result= testDataSheetRow.createCell(16);
				...
				FileOutputStream excelActulaLoginPageText = new FileOutputStream("C:\\Users\\swathi\\Desktop\\SeleniumPractice\\LogInTestUsingMultipleTestData.xlsx"); 
